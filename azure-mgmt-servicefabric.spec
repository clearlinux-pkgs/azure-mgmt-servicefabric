...
Source0  : https://files.pythonhosted.org/packages/12/fb/b10985ab709023472edf69ae058a8a1272e7d0a3525944204b36a2b29360/azure-mgmt-servicefabric-0.5.0.zip
Summary  : Microsoft Azure Service Fabric Management Client Library for Python
Group    : Development/Tools
License  : MIT
Requires: azure-mgmt-servicefabric-python = %{version}-%{release}
Requires: azure-mgmt-servicefabric-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-servicefabric package.
Group: Default
Requires: azure-mgmt-servicefabric-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-servicefabric package.


%package python3
Summary: python3 components for the azure-mgmt-servicefabric package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_servicefabric)
Requires: pypi(azure_common)
Requires: pypi(msrest)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-servicefabric package.


%prep
%setup -q -n azure-mgmt-servicefabric-0.5.0
cd %{_builddir}/azure-mgmt-servicefabric-0.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608047840
